...
test("344 possible designs", () => {
    expect(possibleDesigns(towels, designs)).toEqual(344);
});
...
test("666 options for sample design", () => {
    expect(allPossibleDesigns(towels, designs)).toEqual(344);
});
